 ...
 */
     ...
     var sdkInit = function(initConfig, successcallback, failurecallback) {
         ...
         if (!kony.sdk.isNullOrUndefined(dsAppMetaData) && !kony.sdk.isNullOrUndefined(dsAppServiceDoc)) {
             if (!kony.sdk.isNullOrUndefined(appConfig.svcDoc.service_doc_etag)) {
                 if (!kony.sdk.isNullOrUndefined(kony.sdk.dataStore.getItem(kony.sdk.constants.TOOLS_ETAG_ID)) && kony.sdk.dataStore.getItem(kony.sdk.constants.TOOLS_ETAG_ID) !== appConfig.svcDoc.service_doc_etag) {
 ...
 kony.sdk.util.saveMetadatainDs = function(appKey, appSecret, servConfig) {
     ...
     kony.sdk.logsdk.info("### saveMetadatainDs:: Encrypted Service Doc saved the  in dataStore");
     kony.sdk.dataStore.setItem(appConfig.appId, JSON.stringify(appId));
     kony.sdk.logsdk.info("### saveMetadatainDs:: Encrypted metadata saved successfuly in dataStore");
 };
 /**
