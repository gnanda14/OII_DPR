...
//  --Generated On Fri Dec 20 17:11:27 IST 2019******************* 
//  **************** Start jsonWriter.js*******************
...
kony.sync.clearChunksInServerDBForPayloadId = function(payloadId) {
        ...
        function networkCallback(status, result) {
            sync.log.trace("Entering kony.sync.clearChunksInServerDBForPayloadId networkCallback with result : " + JSON.stringify(result) + " and status : " + status);
            if (status === 400) {
