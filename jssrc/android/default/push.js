...
var push = {
    ...
    CallbacksOfApp: function() {
        try {
            ...
            if (deviceType == "android") push.KMSPROP.osType = "androidgcm";
            else push.KMSPROP.osType = "iphone";
    ...
    onRegistrationSuccess: function(regID) {
        ...
        messagingClient.register(push.KMSPROP.osType, push.KMSPROP.deviceId, regID, push.KMSPROP.UFID, function(response) {
    ...
    getPushNotificationSubscribers: function(gbl_claims_token) {
        try {
            ...
            let headers = {
                "X-Kony-Authorization": gbl_claims_token
            };
