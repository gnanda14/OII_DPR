...
define("userfrmAnalyticsController", {
    ...
    postShow: function(data) {
        if (data.navigatingFrom == "frmDashboard") this.callBtnLastWeek();
    },
    ...
    onClickOfAnalytics: function(inpt) {
        ...
        commonUtils.getDPRAnalyticsData(inpt).then((res) => {
            ...
            if (this.view.flxLineCustom.skin == commonUtils.DASHBOARDSELECTD) this.view.flxFilters.setVisibility(true);
            if (!commonUtils.checkIfEmpty(response) && response.length > 0) {
                ...
                var createChartData = [];
                var createBelowData = [];
                var ColorCodes = ["#4CAAC2", "#3284B3", "#355AA0", "#393E86", "#2F2B64", "#003C72", "#66CCCC", "#59C1E8", "#ABD7EC", "#243566", "#545D89", "#88A4BD", "#1E90CD", "#3267B2", "#0A7CBE", "#50B0C8", "#0099FF", "#66CCFF", "#3399FF", "#0066FF", "#0E98BE", "#8FA3D9", "#7489CE", "#7489CE", "#8B6DA8", "#A021E2", "#C229EB", "#DA53EE", "#769FCA", "#A2D1E6", "#1CA3DE", "#188AF0", "#00B7D8", "#307690", "#09EBEE"];
...
define("frmAnalyticsControllerActions", {
    /*
      This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    /** onTouchEnd defined for donutchart **/
    AS_UWI_ia18b4eb74504b8aa983f1d27e4ea5ac: function AS_UWI_ia18b4eb74504b8aa983f1d27e4ea5ac(eventobject, x, y) {
        var self = this;
    },
    /** onTouchStart defined for donutchart **/
    AS_UWI_b3f4692de0ac4caf9236ae55bc4c4cea: function AS_UWI_b3f4692de0ac4caf9236ae55bc4c4cea(eventobject, x, y) {
        var self = this;
    },
    /** onTouchMove defined for donutchart **/
    AS_UWI_d2a59bd19c824340bdc65d218abcc441: function AS_UWI_d2a59bd19c824340bdc65d218abcc441(eventobject, x, y) {
        var self = this;
    }
});
define("frmAnalyticsController", ["userfrmAnalyticsController", "frmAnalyticsControllerActions"], function() {
    var controller = require("userfrmAnalyticsController");
    var controllerActions = ["frmAnalyticsControllerActions"];
