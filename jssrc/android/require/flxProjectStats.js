define("flxProjectStats", function() {
    return function(controller) {
        var flxProjectStats = new kony.ui.FlexContainer({
        ...
        flxProjectStats.setDefaultUnit(kony.flex.DP);
        ...
        var CopybtnEventDelete0fde0e9d2b5b74a = new kony.ui.Button({
            "focusSkin": "CopysknDummybtnAddCrew0b74c06e4e95947",
            "height": "100%",
            "id": "CopybtnEventDelete0fde0e9d2b5b74a",
            "isVisible": true,
            "right": "0%",
            "skin": "CopysknDummybtnAddCrew0b74c06e4e95947",
            "text": "",
        ...
        flxContainer.add(flxDesc, btnEventDelete, CopybtnEventDelete0fde0e9d2b5b74a);
        flxProjectStats.add(flxContainer);
        return flxProjectStats;
    }
})