define(function() {
    return function(controller) {
        var listboxDPR = new kony.ui.FlexContainer(extendConfig({
            ...
            "width": "100%",
            "zIndex": 2
        }, controller.args[0], "listboxDPR"), extendConfig({}, controller.args[1], "listboxDPR"), extendConfig({}, controller.args[2], "listboxDPR"));
        listboxDPR.setDefaultUnit(kony.flex.DP);
        ...
        var segServiceLine = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "widgetDataMap": {
                "FlexContainer0b32ec8a096394c": "FlexContainer0b32ec8a096394c",
                "flxCrewDprs": "flxCrewDprs",
                "flxLine": "flxLine",
                "flxOrgSearchBox": "flxOrgSearchBox",
                "lblDate": "lblDate",
                "lblProject": "lblProject",
                "lblReportId": "lblReportId"
            },
            "width": "100%"
        ...
        var flxSeparator1 = new kony.ui.FlexContainer(extendConfig({
            ...
            "left": "0",
            "isModalContainer": false,
            "skin": "CopysknFlXfilterSeparator0fe8a78a7f2a547",
            "top": 0,
            "width": "100%"
        ...
        flxCoontainer.add();
        listboxDPR.add(flxFilterContainer, flxCoontainer);
        return listboxDPR;
    }
})