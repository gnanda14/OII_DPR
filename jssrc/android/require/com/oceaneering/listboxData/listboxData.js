define(function() {
    return function(controller) {
        var listboxData = new kony.ui.FlexContainer(extendConfig({
            ...
            "width": "100%",
            "zIndex": 2
        }, controller.args[0], "listboxData"), extendConfig({}, controller.args[1], "listboxData"), extendConfig({}, controller.args[2], "listboxData"));
        listboxData.setDefaultUnit(kony.flex.DP);
        ...
        flxCoontainer.add();
        listboxData.add(flxFilterContainer, flxCoontainer);
        return listboxData;
    }
})