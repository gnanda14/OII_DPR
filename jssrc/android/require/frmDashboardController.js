...
define("userfrmDashboardController", {
    ...
    onClickofSegDashboard: function(role, projectData) {
        try {
            ...
            var req = {
                "$filter": "projectId eq " + projectData.projectId + " and empId eq " + oceaneering.oms.appGlobals.employeeId
            };
        ...
        commonUtils.getProject_Details_staging(inp.projectId).then((res) => {
            ...
            if (!commonUtils.checkIfEmpty(res) && Object.keys(res).length > 0 && !commonUtils.checkIfEmpty(res.ProjectNumber)) {
                ...
                commonUtils.get_project_details(inp.projectId).then((response) => {
                    ...
                    var req = {
                        "$filter": "projectId eq " + inp.projectId + " and empId eq " + oceaneering.oms.appGlobals.employeeId
                    };
                    commonUtils.getProjectSuperCrewList(req).then((res) => {
                        if (res.length === 0) {
                            // need to insert the value in db
	...
	*/
    ...
    moveToRolePopup: function() {
        try {
            ...
            this.view.flxAddProject.animate(kony.ui.createAnimation({
                "100": {
            ...
            this.view.flxCrewOrSupervisor.animate(kony.ui.createAnimation({
                "100": {
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
                    }
    ...
    successCallback_GenerateToken: function(response) {
        if (!commonUtils.checkIfEmpty(response.token)) this.getProfilePic(response.token);
    },
    ...
    animateFAB: function(popupWidget) {
        ...
        popupWidget.animate(kony.ui.createAnimation({
            "100": {
                "centerX": "50%",
                "centerY": "50%",
                "stepConfig": {
        ...
        this.view.flxFAB.animate(kony.ui.createAnimation({
            "100": {
...
define("frmDashboardControllerActions", {
    ...
    */
    ...
    /** onPull defined for segProjects **/
    AS_Segment_ff608702f2de49a8b8b6fdfdd4025803: function AS_Segment_ff608702f2de49a8b8b6fdfdd4025803(eventobject) {
        var self = this;
        this.getProjects();
    },
    /** onPush defined for segProjects **/
    AS_Segment_j3a36dc6eaff408fa40dd551aad11488: function AS_Segment_j3a36dc6eaff408fa40dd551aad11488(eventobject) {
        var self = this;
        kony.print("");
    }
});
