define(['./KonyLogger', './StringEncoder'], function(konyLoggerModule, stringEncoder) {
  ...
  NativeController.prototype.makeNFSCall = function(base64) {
    try {
      ...
      integrationSvc.uploadBinaryData("postFile", params, this.onRawBytesUploadStartCallback, this.onRawBytesChunkUploadCompleteCallback, this.onRawBytesUploadCompleteCallback,
                                      this.onRawBytesUploadFailureCallback, {});
