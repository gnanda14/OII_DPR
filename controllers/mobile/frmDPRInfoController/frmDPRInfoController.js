...
define({ 
  ...
  bindActions : function(){
    try{
      ...
      this.view.onDeviceBack = ()=> {
        commonUtils.navigateTo( "frmDashboard" ,{"navigatingFrom" : "frmDPRInfo", "loadProjects": true});
        formStack = [];
      };
  ...
  */
  ...
  onSettingClick : function(){
    try{
      ...
      var req = {"$filter" : "projectId eq " + this.view.lblProjectIdValue.text};
  ...
  onTopNavClick : function(input){
    try{
      switch(input){
        ...
        case "dpr" : {
          var inp = { "msg" : "Please select the country.", "option" : "error" };
          if(this.view.lblproject.skin == "sknLblSelectedBottom" && commonUtils.checkIfEmpty(this.view.lblCountryId.text)){       
            ...
            inp = { "msg" : "Please select the activity.",  "option" : "error" };
            this.showBottomPopUp(inp);
          }else {
            this.dprTabClick();
          }     
        ...
        case "crew" : {
          if(this.view.lblproject.skin == "sknLblSelectedBottom" && commonUtils.checkIfEmpty(this.view.lblCountryId.text)){         
            var inpt = {  "msg" : "Please select the country.",  "option" : "error" };
            this.showBottomPopUp(inpt);
          }else if(this.view.lblproject.skin == "sknLblSelectedBottom" &&  commonUtils.checkIfEmpty(this.view.lblActivityId.text)){
            var par = {};  
            par = { "msg" : "Please select the activity.", "option" : "error" };
  ...
  */
  ...
  deletePrompt : function(){
    ...
    this.view.bottompopup.btnBottomNotNow.text = "No";
    this.view.bottompopup.btnBottomEnable.text = "Yes";
    this.view.bottompopup.btnBottomEnable.onClick = this.deleteDPR.bind(this ,{"data" : data , "index" : index});
    this.view.bottompopup.btnBottomNotNow.onClick = ()=>{
      this.dismissBottomPopup();
    }; 
    this.view.bottompopup.imgToShow.setVisibility(false);
    ...
    try{
      ...
      commonUtils.getDPRWithDPRID(headerData.str_reportid).then((res)=>{
        ...
        commonUtils.getDPREvents(headerData.str_reportid).then((res)=>{
          ...
          this.toggleLoadingIndicator(false);
          var inp  = { "msg" : commonUtils.errMessage, "option" : "error" };
          var er = { "func" : "submitDpr-dpr", "err" : err.errmsg };   
          commonUtils.exception(this, er , true);
          return;
        });
      }, (err)=>{
  ...
  submitDPRWithEvents : function(inp ,headerData ){
    ...
    commonUtils.submitDPRWithEvents(inp).then((res)=>{ 
      ...
      var inp  = { "msg" : commonUtils.errMessage, "option" : "error"};
      self.showBottomPopUp(inp);
      var er =  { "func" : "submitDPRWithEvents", "err" : err.errmsg };   
      commonUtils.exception(this, er , true);
      return;
    });
  },
    ...
    try{
      ...
      if(submitFinal.status ==  "1"  &&  submitFinal.message == "Success"){
        ...
        commonUtils.UpdateDPRHeader(header).then((values) => {       
          ...
          var er =  { "func" : "afterSubmit", "err" : "Errorcallback " + JSON.stringify(err) };   
          commonUtils.exception(this, er , true);
          return;
        }); 
      } else {
        ...
        var er =  { "func" : "afterSubmit-dpr", "err" : submitFinal.message };   
        commonUtils.exception(this, er , true);
        return;
      }
    } catch(ex){
  ...
  */
  ...
  onClickView : function(){
    try{
      ...
      commonUtils.getDPRWithDPRID(dprHeaderData.str_reportid).then((dprData)=>{
        formStack.push({"frm" : "frmDPRInfo" , params : { navigatingFrom : "frmAddDPR"}});
  ...
  onClickOfRecover: function(){
    ...
    this.view.bottompopup.btnBottomNotNow.text = "No";
    this.view.bottompopup.btnBottomEnable.text = "Yes";
    this.view.bottompopup.btnBottomEnable.onClick = this.onClickRecover.bind(this ,{"data" : data , "index" : index} );
    this.view.bottompopup.btnBottomNotNow.onClick = ()=>{
      this.dismissBottomPopup();
    };  
    this.view.bottompopup.imgToShow.setVisibility(false);
  ...
  onClickRecover : function(input){  
    try{
      ...
      commonUtils.recoverDPr(inp).then((res)=>{
        ...
        var er =  { "func" : "onClickRecover-dpr", "err" : err.errmsg };   
        commonUtils.exception(this, er , true);
      });
    }catch(ex){
      var er = {
  ...
  */
  ...
  onClickOfCreateDPR : function(){
    ...
    formStack.push({"frm" : "frmAddDPR", params : {
  ...
  */
  errorCallback : function(error){
    this.toggleLoadingIndicator(false);
    this.showBottomPopUp({ "msg" : "Sorry, something went wrong. Please try again later.","option" : "error"});
  },
  ...
  */
  getCrewDetails : function(projectId){
    try{
      ...
      var data = {"$filter": "str_projid eq " + projectId};
      var headers = {};
  ...
  */
  onEditCrewMember : function(data){
    formStack.push({
      "frm" : "frmDPRInfo" ,
      params : {"navigatingFrom" : "frmAddCrew"}});
  ...
  */
  onClickOfAddCrew : function(){
    var projectId = this.view.lblProjectIdValue.text;
    var inp = {"projectId": projectId.trim(), "operation": "Add", "isHourlyRate": this.isHourlyRate};
    formStack.push({"frm" : "frmDPRInfo" , params : {"navigatingFrom" : "frmAddCrew"}});
  ...
  onClickOfDeleteCrew : function(index){
    if(commonUtils.checkIfEmpty(index)){    
      this.showBottomPopUp({"msg" : "Sorry! Something went wrong.","option" : "error"});
      return;
    }
  ...
  */
  onClickOfCreateDPRFromCrewDetails : function(index){
    try{    
      ...
      formStack.push({"frm" : "frmDPRInfo" , params : inp});
      commonUtils.navigateTo("frmCreateDPR", inp); 
    }catch(ex){
      commonUtils.exception(this, ex);
      this.view.flxMain.setEnabled(true);
  ...
  onClickSaveSignature : function(response){
    ...
    commonUtils.uploadSignature(inp).then((res)=>{
      ...
      var er =  { "func" : "onClickSaveSignature-dpr", "err" : err.errmsg };   
      commonUtils.exception(this, er , true);
      self.showBottomPopUp(popup);
    });
  },
      ...
      Promise.all(prmce).then((res)=>{
        ...
        commonUtils.createDPRHeader(headerData).then((res)=>{
          Promise.all(promise).then((res)=>{
            ...
            var er =  { "func" : "cloneDPR-Promise", "err" : err.errmsg };          
            commonUtils.exception(this, er , true);
            this.showBottomPopUp();
          });
        }, (err)=>{
          var er =  { "func" : "cloneDPR-createDPRHeader", "err" : err.errmsg };          
          commonUtils.exception(this, er , true);
          this.showBottomPopUp();
        });
      }, (res)=>{
