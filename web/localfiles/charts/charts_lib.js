...
! function(t, e) {
  ...
  st._set("doughnut", {
    ...
    onClick:function(e){	
      ...
      var arr = [];
      arr.push(this.data.labels[activePoints[0]["_index"]]);
      arr.push(this.data.datasets[0].data[activePoints[0]._index]);
      //arr.push(value);

      kony.evaluateJavaScriptInNativeContext("callController",JSON.stringify(arr));	
