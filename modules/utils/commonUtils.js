var commonUtils = {
  ...
  */
  ...
  addbottompopup : function(_this){
    ...
    for(var j = 0; j < filterValues.length ; j++){
      if(!commonUtils.checkIfEmpty(filterValues[j]))
        arr.push(filterValues[j].id);
    }
  ...
  get_project_details : function(projectId){
    try{
      ...
      var data = {"projectId": projectId , maxSyncDateContract : "",  maxSyncDateCategory : "" , maxSyncDateSubCategory : "" , maxSyncDateChildProjects : ""};
      var headers = {};
  ...
  get_project_details_Promise : function(projectId){
    try{
      ...
      var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("Project");
      var operationName = "projectDetails";
      var data = {"projectId": projectId , maxSyncDateContract : date,  maxSyncDateCategory : date , maxSyncDateSubCategory : date , maxSyncDateChildProjects : date};
      var headers = {};
      return new Promise((resolve, reject) => {
        integrationObj.invokeOperation(operationName, headers, data, (res)=>{
          resolve(res);
  ...
  getProject_Details_staging : function(projectId){
    ...
    var data = {"$filter": "ProjectNumber eq " + projectId};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (res)=>{
  ...
  */
  getProjectList : function(){
    ...
    var data = {"empid": oceaneering.oms.appGlobals.employeeId};
    var headers = {};
    return new Promise((resolve, reject) => {
  ...
  */
  employeeSearch : function(inp){
    ...
    var data = {searchText : inp.searchText , resultCount : 30 , pageNumber : inp.limit};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (res)=>{
  ...
  */
  jobCode : function(searchText){
    ...
    var data = {"title" : searchText , "resultCount" : 50};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (res)=>{
        if(!commonUtils.checkIfEmpty(res) && Object.keys(res).length > 0){
  ...
  */
  crewPosition : function(){
    ...
    var data = {"serviceLine" : oceaneering.oms.appGlobals.selServiceLineValue};
    var headers = {};
    return new Promise((resolve, reject) => {
  ...
  */
  ...
  recoverDPr : function(inp){
    ...
    var data = { "reportId" : inp.reportId , "novelId" : oceaneering.oms.appGlobals.username };
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
    ...
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
          ...
          reject({"errmsg" : result.message});
        }
      },(err)=>{
        var er =  { "func" : "submitDPRWithEvents", "err" : "Errorcallback " + JSON.stringify(err) };   
  ...
  uploadSignature : function(inp){
    ...
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, inp, (result)=>{
        ...
        var er =  { "func" : "uploadSignature", "err" : "Errorcallback " + JSON.stringify(err) };   
        commonUtils.exception(this, er , true);
        reject(err);
      });
    });
  ...
  getDPRPersonnel : function(inp){
    ...
    var data = {"$filter": " eq " + inp.projectId + " and reportDate eq " + inp.reportDate};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getDPRHeader : function(projectId){
    ...
    var data = {"$filter": "projectId eq " + projectId }; //+ " and reportDate eq " + inp.reportDate};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getDPRHeaderWithDPRID : function(reportId){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_Dailyreportheader_get";
    var data = {"$filter": "str_reportid eq " + reportId };
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getAllDPRForProject : function(projectId){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_Dailyreportheader_get";
    var data = { "$filter": "str_projid eq " + projectId, "$orderby" : "dte_reportdate desc" };
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getAllDPRForProjectToday : function(inp){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_Dailyreportheader_get";
    var data = { "$filter": "str_projid eq " + inp.projectId +" and dte_reportdate eq " + inp.date  + " and lng_status eq 0", "$orderby" : "dte_lastModified desc" };
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  */
  getDPRWithDPRID : function(reportid){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_DailyReportPersonnel_get";
    var data = {"$filter": "str_dprId eq " + reportid};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result) =>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getAllDPRForEMPID : function(inp){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_Dailyreportheader_get";
    var data = { "$filter": "str_supervisor eq " + inp.employeeId + " or str_supervisor eq "+ inp.employeeId};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  */
  ...
  getDPRPersonnelHistory : function(empid){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_DailyReportPersonnel_get";
    var data = {"$filter": "str_employeeid eq " + empid};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){        
  ...
  getDPRHeaderHistory : function(empid){
    var integrationObj = oceaneering.oms.appGlobals.client.getIntegrationService("StagingDBOMS");
    var operationName = "dbo_OMS_OP_Dailyreportheader_get";
    var data = {"$filter": "str_CreatedBy eq " + empid + " or str_lastModifiedBy eq  "+ empid , "$orderby" : "dte_reportdate desc"};
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getDPREvents : function(reportId){
    ...
    var data = {"$filter": "str_report_id eq " + reportId };
    var headers = {};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result) =>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
  ...
  getEventActivities : function(projectid){
    ...
    var headers = {};
    var data = {"$filter": "projectid eq " + projectid };
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
    ...
    if(!commonUtils.checkIfEmpty(data) && data.length > 0){
      ...
      for(var j = 0; j < data.length; j++){
        var res = {
          ...
          /*mob */ "expat" : data[j].bln_mob === false || data[j].bln_mob == "false" ? false : true,
          /*demob*/ "localTechnician" : data[j].bln_demob === false || data[j].bln_demob == "false" ? false : true,    
          /*ADHOC */ "RosterStatus" : commonUtils.checkIfEmpty(data[j].bln_ADHOC) ? 81300 : data[j].bln_ADHOC == "true" ? 81301 : 81300,
        };
        arr.push(res);
      }
      return arr;
  ...
  getAttachments : function(reportId , docid){
    ...
    var headers = {};
    var data = {"$filter": "reportId eq " + reportId + " and str_docid eq " + docid};
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
          resolve(result.OMS_OP_Attachments);
  ...
  getAttachmentsList : function(reportId){
    ...
    var headers = {};
    var data = { "$filter": "reportId eq " + reportId };
    return new Promise((resolve, reject) => {
      integrationObj.invokeOperation(operationName, headers, data, (result)=>{
        if(!commonUtils.checkIfEmpty(result) && Object.keys(result).length > 0){
          resolve(result.OMS_OP_Attachments_List);
  ...
  getDPRHeaderReturn : function(headerData){
    try {
      ...
      Object.keys(header).forEach((key) => {
        if(header[key] === null || header[key] === ""  || header[key] === undefined)
          header[key] = null;
      });
      return header;
    }catch(ex){
  ...
  pushAppUsage : function(){
    try {      
      ...
      integrationObj.invokeOperation(operationName, {}, data, (res)=>{
        ...
        var er =  { "func" : "pushAppUsage", "err" : "Errorcallback " + JSON.stringify(err) };   
        commonUtils.exception(this, er , true);
